...
<head>
    ...
    <!-- ONLY ONE CSS FILE - THIS IS THE ONLY ONE THAT LOADS -->
    <link rel="stylesheet" href="/SkillSeek/assets/css/final.css">
</head>
</head>
<body>
    ...
    <div class="header-inner">
        ...
        <div class="header-logo">
            <a href="/SkillSeek/index.php">
                <img src="/SkillSeek/assets/images/logo.jpeg" alt="SkillSeek" class="logo-image">
            ...
            <?php if ($user_id): ?>
                ...
                <div class="user-dropdown">
                    ...
                    <div class="dropdown-menu" id="userMenu">
                        ...
                        <?php endif; ?>
                        <hr>
                        <a href="/SkillSeek/profile.php"><i class="fas fa-user"></i> Profile</a>
    ...
    <div class="mobile-menu" id="mobileMenu">
        <ul>
            <?php if ($user_id && $user_role === 'employer'): ?>
                ...
                <li><a href="/SkillSeek/employer/post_job.php">Post Job</a></li>
                <li><a href="/SkillSeek/employer/my_jobs.php">My Jobs</a></li>
                <li><a href="/SkillSeek/employer/applications.php">Applications</a></li>
            ...
            <?php elseif ($user_id && $user_role === 'student'): ?>
                ...
                <li><a href="/SkillSeek/student/profile.php">Profile</a></li>
                <li><a href="/SkillSeek/auth/logout.php">Logout</a></li>
            <?php else: ?>
                <li><a href="/SkillSeek/index.php">Home</a></li>
                <li><a href="/SkillSeek/jobs.php">Browse Jobs</a></li>
                <li><a href="/SkillSeek/auth/login.php">Login</a></li>
                <li><a href="/SkillSeek/auth/register.php">Register</a></li>
            <?php endif; ?>
        </ul>
    </div>
</header>
